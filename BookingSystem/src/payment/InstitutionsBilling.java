...
public class InstitutionsBilling extends Payment{
	
	//Arbitrary Fee to differentiate payment methods
	
	private static final double FEE = 3.5;
	
	public InstitutionsBilling(double hourlyRate, String startTime, String endTime, String cardInformation, int deposit) {
